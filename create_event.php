...
<body>
    ...
    <div class="container">
    	<div class="section">
            ...
            <!--<form method="POST" action="process_event.php" class="col s12">
                <div class="row">
                ...
                <button class="btn-large waves-effect waves-light blue" type="submit" name="action">Submit your RSVP</button>
            </form>-->
            </div>
